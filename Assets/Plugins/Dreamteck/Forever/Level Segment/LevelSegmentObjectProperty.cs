        ...
        public class ObjectProperty
        {
...
#if DREAMTECK_SPLINES
                if (extrusionSettings.bendSpline && splineComputer != null) splineComputer.ResampleTransform();
                else extrusionSettings.bendSpline = false;
#endif
                if (meshFilter != null)
                {
            ...
            public void RuntimeApply()
            {
                ...
                if (splineComputer != null)
                {
                    ...
                    if (extrusionSettings.bendSpline) splineComputer.SetPoints(editSplinePoints);
                }
#endif
            }
