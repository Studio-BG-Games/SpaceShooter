namespace Dreamteck.Forever
{
    ...
    public class WelcomeScreen : WelcomeWindow
    {
        ...
        public override void Load()
        {
            ...
            panels[0].elements.Add(new WindowPanel.Thumbnail("Forever/Editor/Images", "dreamteck_splines", "Dreamteck Splines", "Need a good spline solution for your games? Try Dreamteck Splines. It's integrated with Forever too!", new ActionLink("http://u3d.as/sLk")));
            panels[0].elements.Add(new WindowPanel.Space(400, 10));
