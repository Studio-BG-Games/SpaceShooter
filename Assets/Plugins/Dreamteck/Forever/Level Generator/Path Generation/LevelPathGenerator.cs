...
namespace Dreamteck.Forever
{
    public class LevelPathGenerator : ScriptableObject
    {
        ...
        protected bool useCustomRule = false;
        protected CustomPathRule customRule = null;
        ...
        protected virtual void GeneratePoint(ref SplinePoint point, int pointIndex)
        {
            ...
            if (useCustomRule)
            {
                customRule.OnGeneratePoint(point, lastPoint, pointIndex, controlPointsPerSegment);
            }
        }
