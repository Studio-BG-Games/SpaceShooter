...
namespace Dreamteck.Forever
{
    ...
    public class LevelGenerator : MonoBehaviour
    {
        ...
        public LevelPathGenerator pathGenerator
        {
            ...
            set
            {
                if (value == _sharedPathGenerator || (usePathGeneratorInstance && value == pathGeneratorInstance)) return;
                ...
                if (Application.isPlaying && usePathGeneratorInstance)
                {
                    ...
                    pathGeneratorInstance.Continue(_sharedPathGenerator);
                }
        ...
        public void StartGeneration()
        {
            ...
            if (usePathGeneratorInstance)
            {
                ...
                pathGeneratorInstance = Instantiate(_sharedPathGenerator);
            }
            overridePathGenerator = null;
