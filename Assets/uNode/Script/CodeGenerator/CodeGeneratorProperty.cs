...
namespace MaxyGames {
	public static partial class CG {
        #region Constant
		private const string _coroutineEventCode = "_ExecuteCoroutineEvent";
		private const string _activateActionCode = "_ExecuteAction";
		private const string _debugGetValueCode = "_DebugGetValue";
		private const string _runtimeInterfaceKey = "i:";
		#endregion
		...
		/// The target uNode.
		/// </summary>
		public static uNodeRoot graph { get; private set; }
		/// <summary>
		/// The target State Graph.
		/// </summary>
		public static IStateGraph stateGraph => graph as IStateGraph;
		/// <summary>
