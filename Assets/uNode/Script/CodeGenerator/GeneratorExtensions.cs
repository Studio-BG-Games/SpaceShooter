...
namespace MaxyGames {
	...
	public static class GeneratorExtensions {
		...
		/// <returns></returns>
		public static string CGFlow(this MemberData value, uNode.Node from, bool waitTarget = true) {
			return CG.Flow(value, from, waitTarget);
		}
		...
		public static string CGName(this string str, object owner) {
			return CG.GenerateVariableName(str, owner);
		}
		...
		/// <param name="index"></param>
		/// <returns></returns>
		public static string CGAccessElement(this object instance, string index) {
			return CG.AccessElement(instance, index);
		}
		...
		/// <param name="members"></param>
		/// <returns></returns>
		public static string CGAccess(this object first, params string[] members) {
			return CG.Access(first, members);
		}
		...
		/// <param name="paramObject"></param>
		/// <returns></returns>
		public static string CGInvoke<T>(this string instance, string functionName, params string[] paramObject) {
			return CG.Invoke(instance, functionName, new[] { typeof(T) }, paramObject);
		}
		...
		/// <param name="paramObject"></param>
		/// <returns></returns>
		public static string CGInvoke(this object instance, string functionName, params string[] paramObject) {
			return CG.Invoke(instance, functionName, paramObject);
		}
		...
		/// <param name="paramObject"></param>
		/// <returns></returns>
		public static string CGInvoke(this object instance, string functionName, Type[] genericType, params string[] paramObject) {
			return CG.Invoke(instance, functionName, genericType, paramObject);
		}
		...
		/// <param name="paramObject"></param>
		/// <returns></returns>
		public static string CGFlowInvoke(this string instance, string functionName, params string[] paramObject) {
			return CG.FlowInvoke(instance, functionName, paramObject);
		}
		...
		/// <param name="paramObject"></param>
		/// <returns></returns>
		public static string CGFlowInvoke(this object instance, string functionName, params string[] paramObject) {
			return CG.FlowInvoke(instance, functionName, paramObject);
		}
		...
		/// <param name="paramObject"></param>
		/// <returns></returns>
		public static string CGFlowInvoke(this object instance, string functionName, Type[] genericType, params string[] paramObject) {
			return CG.FlowInvoke(instance, functionName, genericType, paramObject);
		}
		...
		/// <param name="paramObject"></param>
		/// <returns></returns>
		public static string CGFlowInvoke(this Type type, string functionName, params string[] paramObject) {
			return CG.FlowInvoke(type, functionName, paramObject);
		}
		...
		/// <param name="paramObject"></param>
		/// <returns></returns>
		public static string CGFlowInvoke(this Type type, string functionName, Type[] genericType, params string[] paramObject) {
			return CG.FlowInvoke(type, functionName, genericType, paramObject);
		}
		#endregion
		...
		public static string CGConvert(this string instance, Type convertType, bool extension = false) {
			if(extension) {
				CG.RegisterUsingNamespace("MaxyGames");
