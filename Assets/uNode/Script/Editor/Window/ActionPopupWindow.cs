...
namespace MaxyGames.uNode.Editors {
	...
	public class ActionPopupWindow : EditorWindow {
		...
		public static ActionPopupWindow ShowWindow(Rect rect, Action onGUI,
			Action onGUITop, Action onGUIBottom, float width = 250, float height = 100) {
			ActionPopupWindow window = CreateInstance(typeof(ActionPopupWindow)) as ActionPopupWindow;
			if(onGUI != null)
				window.onGUI = delegate(ref object obj) { onGUI(); };
		...
		public static ActionPopupWindow ShowWindow(Vector2 pos, object startValue, float width = 250, float height = 100) {
			ActionPopupWindow window = CreateInstance(typeof(ActionPopupWindow)) as ActionPopupWindow;
			window.variable = startValue;
			window.width = width;
			window.height = height;
		...
		public static ActionPopupWindow ShowWindow(Vector2 pos, Action onGUI, float width = 250, float height = 100) {
			ActionPopupWindow window = CreateInstance(typeof(ActionPopupWindow)) as ActionPopupWindow;
			if(onGUI != null)
				window.onGUI = delegate(ref object obj) { onGUI(); };
			window.width = width;
		...
		public static ActionPopupWindow ShowWindow(Vector2 pos, object startValue, ActionRef<object> onGUI,
			ActionRef<object> onGUITop, ActionRef<object> onGUIBottom, float width = 250, float height = 100) {
			ActionPopupWindow window = CreateInstance(typeof(ActionPopupWindow)) as ActionPopupWindow;
			window.variable = startValue;
			window.onGUI = onGUI;
