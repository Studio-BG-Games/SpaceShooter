...
namespace MaxyGames.uNode.Editors {
	public partial class ItemSelector : EditorWindow {
		...
		#region ShowWindows
		public static ItemSelector ShowType(UnityEngine.Object targetObject, FilterAttribute filter, Action<MemberData> selectCallback) {
			if(filter == null) {
		...
		public static ItemSelector ShowCustomItem(List<CustomItem> customItems, Action<MemberData> selectCallback = null, FilterAttribute filter = null) {
			var win = ShowWindow(null, null, filter, selectCallback, customItems);
