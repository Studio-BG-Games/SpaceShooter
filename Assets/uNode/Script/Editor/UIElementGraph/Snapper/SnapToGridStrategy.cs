...
namespace MaxyGames.uNode.Editors {
	class SnapToGridStrategy : SnapStrategy {
		...
		public override void UpdateSnap() {
            ...
            Enabled = preference.enableSnapping && preference.gridSnapping;
		}
		...
		List<SnapToGridResult> GetClosestGridLines(Rect sourceRect) {
			List<SnapToGridResult> results = GetClosestGridLines(sourceRect, Orientation.Horizontal);
			return results.Union(GetClosestGridLines(sourceRect, Orientation.Vertical)).ToList();
		}
