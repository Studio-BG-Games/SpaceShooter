...
namespace MaxyGames.uNode.Editors {
	public class MinimapView : GraphElement, IElementResizable {
		...
		private VerticalEditorTheme.MinimapType m_MinimapType;
		...
		private VerticalEditorTheme.MinimapType minimapType {
			get {
			...
			set {
				if(m_MinimapType != value) {
					m_MinimapType = value;
					if(m_MinimapType != VerticalEditorTheme.MinimapType.Floating) {
		...
		public virtual void BuildContextualMenu(ContextualMenuPopulateEvent evt) {
			if(minimapType == VerticalEditorTheme.MinimapType.Floating) {
				evt.menu.AppendAction("Anchor", (act) => {
					minimapType = VerticalEditorTheme.MinimapType.Anchored;
				...
				evt.menu.AppendAction("Make floating", (act) => {
					minimapType = VerticalEditorTheme.MinimapType.Floating;
					UIElementUtility.Theme.minimapType = minimapType;
					EditorUtility.SetDirty(UIElementUtility.Theme);
				}, DropdownMenuAction.AlwaysEnabled);
			}
			evt.menu.AppendSeparator();
			if(minimapType != VerticalEditorTheme.MinimapType.UpperLeft) {
				evt.menu.AppendAction("Snap to/Upper Left", (act) => {
					minimapType = VerticalEditorTheme.MinimapType.UpperLeft;
					UIElementUtility.Theme.minimapType = minimapType;
					EditorUtility.SetDirty(UIElementUtility.Theme);
				}, DropdownMenuAction.AlwaysEnabled);
			}
			if(minimapType != VerticalEditorTheme.MinimapType.UpperRight) {
				evt.menu.AppendAction("Snap to/Upper Right", (act) => {
					minimapType = VerticalEditorTheme.MinimapType.UpperRight;
					UIElementUtility.Theme.minimapType = minimapType;
					EditorUtility.SetDirty(UIElementUtility.Theme);
				}, DropdownMenuAction.AlwaysEnabled);
			}
			if(minimapType != VerticalEditorTheme.MinimapType.BottomLeft) {
				evt.menu.AppendAction("Snap to/Bottom Left", (act) => {
					minimapType = VerticalEditorTheme.MinimapType.BottomLeft;
					UIElementUtility.Theme.minimapType = minimapType;
					EditorUtility.SetDirty(UIElementUtility.Theme);
				}, DropdownMenuAction.AlwaysEnabled);
			}
			if(minimapType != VerticalEditorTheme.MinimapType.BottomRight) {
				evt.menu.AppendAction("Snap to/Bottom Right", (act) => {
					minimapType = VerticalEditorTheme.MinimapType.BottomRight;
					UIElementUtility.Theme.minimapType = minimapType;
					EditorUtility.SetDirty(UIElementUtility.Theme);
				}, DropdownMenuAction.AlwaysEnabled);
			}
		...
		private void DrawContent() {
			...
			{//Layout
				switch(minimapType) {
					case VerticalEditorTheme.MinimapType.BottomLeft:
						style.left = 0;
						style.top = parent.layout.height - layout.height;
						break;
					case VerticalEditorTheme.MinimapType.BottomRight:
						style.left = parent.layout.width - layout.width;
						style.top = parent.layout.height - layout.height;
						break;
					case VerticalEditorTheme.MinimapType.UpperLeft:
						style.left = 0;
						style.top = 0;
						break;
					case VerticalEditorTheme.MinimapType.UpperRight:
						style.left = parent.layout.width - layout.width;
						style.top = 0;
						break;
				}
