...
namespace MaxyGames {
	public static class Operator {
		...
		public static object Convert(object value, Type type) {
			if(type is RuntimeType) {
				...
				} else if(type is RuntimeGraphInterface || value is uNodeAssetInstance) {
					return value;
	...
	public static class Operators {
		...
		public static object Add(object a, object b, Type fType, Type tType) {
			...
			var uid = uNodeUtility.GenerateUID(fType.GetHashCode(), tType.GetHashCode());
		...
		public static object Convert(object a, Type type) {
			...
			var uid = uNodeUtility.GenerateUID(type.GetHashCode(), fromType.GetHashCode());
