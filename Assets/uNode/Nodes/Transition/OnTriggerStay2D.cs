namespace MaxyGames.uNode.Transition {
	...
	public class OnTriggerStay2D : TransitionEvent {
		...
		public override void OnEnter() {
			UEvent.Register<UnityEngine.Collider2D>(UEventID.OnTriggerStay2D, owner, Execute);
		}

		public override void OnExit() {
			UEvent.Unregister<UnityEngine.Collider2D>(UEventID.OnTriggerStay2D, owner, Execute);
		}
