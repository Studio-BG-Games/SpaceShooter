namespace MaxyGames.uNode.Transition {
	...
	public class OnTriggerExit2D : TransitionEvent {
		...
		public override void OnEnter() {
			UEvent.Register<UnityEngine.Collider2D>(UEventID.OnTriggerExit2D, owner, Execute);
		}

		public override void OnExit() {
			UEvent.Unregister<UnityEngine.Collider2D>(UEventID.OnTriggerExit2D, owner, Execute);
		}
