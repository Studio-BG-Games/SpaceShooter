namespace MaxyGames.uNode.Transition {
	...
	public class OnCollisionExit : TransitionEvent {
		...
		public override void OnEnter() {
			UEvent.Register<UnityEngine.Collision>(UEventID.OnCollisionExit, owner, Execute);
		}

		public override void OnExit() {
			UEvent.Unregister<UnityEngine.Collision>(UEventID.OnCollisionExit, owner, Execute);
		}
