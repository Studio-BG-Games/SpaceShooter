...
namespace Services.Inputs
{
    public class PcInput : MonoBehaviour, IInput
    {
        ...
        public Vector2 MoveDir =>new Vector2(Input.GetAxis("Horizontal"), Input.GetAxis("Vertical")); 
        ...
        public void Update()
        {
            ...
            if(Input.GetKey(KeyCode.LeftShift)) ChangeWeapon?.Invoke();
            //if(Input.GetKey(KeyCode.Mouse0) || Input.GetKey(KeyCode.Space)) Fire?.Invoke();
            if(Input.GetKey(KeyCode.Space)) Fire?.Invoke();
